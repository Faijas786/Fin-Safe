...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('finsafe_app', '0016_delete_chatmessage_remove_deposit_member_and_more'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateTimeField(auto_now_add=True)),
                ('member', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='transactions', to='finsafe_app.member')),
            ],
        ),
        migrations.CreateModel(
            name='Withdraw',
